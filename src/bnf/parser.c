	...
	case (TOK_NAME): case (TOK_LITERAL): case (TOK_CHAR):
		{
			...
			prod_89 (lex_state, act_state, &ZIt);
			if ((CURRENT_TERMINAL) == (ERROR_TERMINAL)) {
				RESTORE_LEXER;
				goto ZL1;
			}
...
static void
prod_89(lex_state lex_state, act_state act_state, map_term *ZOt)
{
	map_term ZIt;
