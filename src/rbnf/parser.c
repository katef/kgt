				...
				default:
					{
						...
						{
#line 411 "src/parser.act"

		(ZImin) = 0;
		(ZImax) = 1;
	
#line 352 "src/rbnf/parser.c"
						}
...
ZL1:;
	{
		...
		{
#line 506 "src/parser.act"

		(ZIl) = NULL;
	
#line 538 "src/rbnf/parser.c"
		}
