				...
				case (TOK_REP):
					{
						...
						{
#line 326 "src/parser.act"

		(ZImin) = 0;
		(ZImax) = 0;
	
#line 288 "src/rbnf/parser.c"
						}
				...
				default:
					{
						...
						{
#line 331 "src/parser.act"

		(ZImin) = 0;
		(ZImax) = 1;
	
#line 302 "src/rbnf/parser.c"
						}
