...
static void prod_84(lex_state, act_state, map_rule *);
static void prod_85(lex_state, act_state, map_term *, map_alt *);
static void prod_86(lex_state, act_state, map_term *);
...
prod_list_Hof_Hrules(lex_state lex_state, act_state act_state, map_rule *ZOl)
{
	...
	}
	{
		...
		prod_84 (lex_state, act_state, &ZIl);
		if ((CURRENT_TERMINAL) == (ERROR_TERMINAL)) {
			RESTORE_LEXER;
			goto ZL1;
		}
...
prod_list_Hof_Halts(lex_state lex_state, act_state act_state, map_alt *ZOl)
{
	...
	}
	{
		...
		prod_85 (lex_state, act_state, &ZIt, &ZIl);
		if ((CURRENT_TERMINAL) == (ERROR_TERMINAL)) {
			RESTORE_LEXER;
			goto ZL1;
		}
...
#line 492 "src/ebnf/parser.c"
			...
			{
#line 220 "src/parser.act"

		/* TODO */
		*lex_state->p++ = (ZIc);
	
#line 510 "src/ebnf/parser.c"
			}
...
#line 721 "src/ebnf/parser.c"
		...
		{
#line 349 "src/parser.act"

		(ZIr) = ast_make_rule((ZIs), (ZIa));
	
#line 739 "src/ebnf/parser.c"
		}
		...
		ZL5:;
			{
				...
				{
#line 391 "src/parser.act"

		err_expected(lex_state, "production rule separator");
	
#line 762 "src/ebnf/parser.c"
				}
...
static void
prod_84(lex_state lex_state, act_state act_state, map_rule *ZIl)
{
	switch (CURRENT_TERMINAL) {
	case (TOK_IDENT):
		{
...
static void
prod_85(lex_state lex_state, act_state act_state, map_term *ZIt, map_alt *ZOl)
{
	map_alt ZIl;
...
static void
prod_86(lex_state lex_state, act_state act_state, map_term *ZIl)
{
	switch (CURRENT_TERMINAL) {
	case (TOK_CAT):
		{
			...
			{
#line 358 "src/parser.act"

		assert((*ZIl)->next == NULL);
		(*ZIl)->next = (ZIt);
	
#line 1008 "src/ebnf/parser.c"
			}
