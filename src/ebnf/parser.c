	...
	case (TOK_COUNT):
		{
			...
			{
#line 294 "src/parser.act"

		ZIn = strtoul(lex_state->buf.a, NULL, 10);
		/* TODO: range check */
	
#line 912 "src/ebnf/parser.c"
			}
