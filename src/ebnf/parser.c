...
static void prod_75(lex_state, act_state, map_rule *);
static void prod_76(lex_state, act_state, map_term *, map_alt *);
static void prod_77(lex_state, act_state, map_term *);
...
#line 161 "src/ebnf/parser.c"
			...
			{
#line 188 "src/parser.act"

		(ZImin) = 1;
		(ZImax) = 1;
	
#line 171 "src/ebnf/parser.c"
			}
			/* END OF ACTION: rep-one */
			/* BEGINNING OF ACTION: set-repeat */
			{
#line 208 "src/parser.act"
...
#line 365 "src/ebnf/parser.c"
		}
		/* END OF ACTION: make-empty-rule */
		/* BEGINNING OF ACTION: err-syntax */
		{
#line 308 "src/parser.act"

		err(lex_state, "Syntax error");
		exit(EXIT_FAILURE);
	
#line 375 "src/ebnf/parser.c"
		}
...
prod_list_Hof_Hterms(lex_state lex_state, act_state act_state, map_term *ZOl)
{
	...
	}
	{
		...
		prod_77 (lex_state, act_state, &ZIl);
		if ((CURRENT_TERMINAL) == (ERROR_TERMINAL)) {
			RESTORE_LEXER;
			goto ZL1;
		}
...
prod_list_Hof_Halts(lex_state lex_state, act_state act_state, map_alt *ZOl)
{
	...
	}
	{
		...
		prod_76 (lex_state, act_state, &ZIt, &ZIl);
		if ((CURRENT_TERMINAL) == (ERROR_TERMINAL)) {
			RESTORE_LEXER;
			goto ZL1;
		}
			...
			{
				{
					...
					case (TOK_CHAR):
						...
						{
#line 143 "src/parser.act"

		assert(strlen(lex_state->buf.a) == 1);

		ZIc = lex_state->buf.a[0];
	
#line 479 "src/ebnf/parser.c"
						}
						/* END OF EXTRACT: CHAR */
						break;
					default:
		...
		ZL3:;
			{
				...
				{
#line 320 "src/parser.act"

		err_expected(lex_state, "production rule assignment");
	
#line 690 "src/ebnf/parser.c"
				}
...
static void
prod_75(lex_state lex_state, act_state act_state, map_rule *ZIl)
{
	switch (CURRENT_TERMINAL) {
	case (TOK_IDENT):
		{
...
static void
prod_76(lex_state lex_state, act_state act_state, map_term *ZIt, map_alt *ZOl)
{
	map_alt ZIl;
...
static void
prod_77(lex_state lex_state, act_state act_state, map_term *ZIl)
{
	switch (CURRENT_TERMINAL) {
	case (TOK_CAT):
		{
