...
extern void prod_ebnf_Hgrammar(map_production *);
static void prod_59(map_production *);
static void prod_term(map_term *);
static void prod_60(map_term *, map_alt *);
static void prod_61(map_term *);
static void prod_repeatable_Hfactor(map_term *);
...
void
prod_ebnf_Hgrammar(map_production *ZOl)
{
	map_production ZIl;
...
static void
prod_60(map_term *ZIt, map_alt *ZOl)
{
	map_alt ZIl;
...
static void
prod_repeatable_Hfactor(map_term *ZOt)
{
	map_term ZIt;
